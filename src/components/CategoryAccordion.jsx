        ...
        <div className="p-2 space-y-2">
          {category.components.map((component) => (
            <div
              ...
              draggable
              onDragStart={(e) => {
                console.log("Drag started for:", component.type);
              ...
              onDragEnd={(e) => {
                console.log("Drag ended for:", component.type);
              }}
              className="flex items-center justify-between px-3 py-2 rounded-md bg-gray-100 hover:bg-gray-200 cursor-move text-sm select-none"
            >
