...
export default function QuoteOptions({ block, handleChange, onDelete }) {
      ...
      <section>
        ...
        <div>
          ...
          <input
            ...
            step="1"
            value={
              props.contentFontSize !== null &&
              props.contentFontSize !== undefined
                ? parseFloat(props.contentFontSize)
                : 16
            }
            onChange={(e) =>
              handleNumericChange("contentFontSize", e.target.value, "px")
            }
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleTextChange("authorNameColor", e.target.value)
            }
            className="mt-1 block w-full h-8"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleTextChange("authorTitleColor", e.target.value)
            }
            className="mt-1 block w-full h-8"
          />
        </div>
      ...
      <section>
        ...
        <div>
          ...
          <input
            ...
            value={
              props.authorImageSize !== null &&
              props.authorImageSize !== undefined
                ? parseFloat(props.authorImageSize)
                : 80
            }
            onChange={(e) =>
              handleNumericChange("authorImageSize", e.target.value, "px")
            }
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          />
        </div>
      ...
      <section>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleTextChange("backgroundColor", e.target.value)
            }
            className="mt-1 block w-full h-8"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleNumericChange("borderWidth", e.target.value, "px")
            }
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          />
        </div>
