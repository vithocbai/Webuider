...
const ButtonOptions = ({ block, handleChange, onDelete }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="space-y-2">
        <h4 className="text-md font-semibold text-gray-700 border-b pb-2 mb-2">
          Content
        </h4>
        <div>
      ...
      <section className="space-y-2">
        ...
        {/* Căn chỉnh nội dung bên trong nút */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Text Align (Inside Button)
          </label>
          <select
            className="w-full border rounded px-2 py-1"
        ...
        {/* Căn chỉnh khối button trong phần tử cha */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <select
            className="w-full border rounded px-2 py-1"
            value={props.blockAlignment || "left"}
            onChange={(e) => handleChange("blockAlignment", e.target.value)}
          >
            <option value="left">Left</option>
            <option value="center">Center</option>
            <option value="right">Right</option>
        ...
        {/* Tái sử dụng TextOptions cho các định dạng văn bản như fontSize, bold, italic, etc. */}
      ...
      <section className="space-y-2">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleNumericChange("borderRadius", e.target.value, "px")
            } // Sử dụng handleNumericChange
          />
        </div>
      </section>
      {/* HOVER EFFECTS */}
          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("hoverBackgroundColor", e.target.value)
                }
              />
            </div>
            <div>
